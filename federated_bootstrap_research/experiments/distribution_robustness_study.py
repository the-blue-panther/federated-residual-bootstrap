"""Distribution robustness study for Local Residual Bootstrap.

Evaluates performance under multiple error distributions.
"""
...
def run_distribution_robustness_study(
    n: int = 1000,
    p: int = 5,
    ...
    distributions: List[str] = ["iid", "heavy_tailed", "heavy_tailed_5", "skewed", "gamma", "heteroscedastic"],
    save_results: bool = True,
    results_dir: str = "results/phase_2_validation/distribution_robustness",
) -> Dict[str, Any]:
    """
    Run distribution robustness study.
    ...
    print("=" * 70)
    print("DISTRIBUTION ROBUSTNESS STUDY")
    print("=" * 70)
    print(f"\nConfiguration:")
    ...
    for dist_idx, distribution in enumerate(distributions, 1):
        ...
        for i in range(n_mc):
            ...
            # Generate data
            sim_seed = (random_state + dist_idx * 100000 + i * 1000) if random_state is not None else None
        ...
        if save_results:
            ...
            summary_path = results_path / f"robustness_{distribution}.csv"
...
if __name__ == "__main__":
    run_distribution_robustness_study(
        n=1000,
        p=5,
        n_bootstrap=500,
